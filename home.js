...
function canWeDeliver(zipcode){
    if(zipcode === true )console.log('you are inside our delivery area!')
        
(zipcode === false )console.log('youre not inside our delivery area!')
...
// CODE HERE
function canWeDeliverTwo(zipcode)= deliveryAreaZipCodes.includes(0,1)
...
//CODE HERE
let newtitle = '10% off'
let discount = newtitle.replace(title)
